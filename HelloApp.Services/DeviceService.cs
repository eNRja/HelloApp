...
namespace HelloApp.Services
{
    ...
    {
        private readonly IRepository<DataAccess.DbDevice> _deviceRepository;
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public DeviceService(IRepository<DataAccess.DbDevice> deviceRepository, IUnitOfWork unitOfWork, IMapper mapper)
        {
        ...
        {
            var dataDevice = _mapper.Map<DataAccess.DbDevice>(serviceDevice);
